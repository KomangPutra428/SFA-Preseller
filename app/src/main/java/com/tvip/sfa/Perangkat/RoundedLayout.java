...
public class RoundedLayout extends RelativeLayout {
    private final Path mPathCorners = new Path();
     ...
     * border path
     */
    private final Path mPathCornersBorder = new Path();
    private final Path mPathCircleBorder = new Path();
    ...
    private final RectF rectBorder = new RectF(0, 0, 0, 0);
