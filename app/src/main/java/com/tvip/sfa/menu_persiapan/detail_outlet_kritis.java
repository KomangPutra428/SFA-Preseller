...
public class detail_outlet_kritis extends AppCompatActivity {
    ...
    private void getTrend() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://apisec.tvip.co.id/" + sharedPreferences.getString("link", null) + "/utilitas/Persiapan/index_TrendSalesListProduk?tanggal="+dateOutput+"&szCustomerId=" + getIntent().getStringExtra("SzId"),
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
...
//                        pDialog.dismissWithAnimation();
    ...
    private void getPiutang() {
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://apisec.tvip.co.id/" + sharedPreferences.getString("link", null) + "/utilitas/Persiapan/index_InfoPiutang?szCustomerId=" + getIntent().getStringExtra("SzId"),
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
...
//                        pDialog.dismissWithAnimation();
    ...
    private void getSOHistory() {
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://apisec.tvip.co.id/" + sharedPreferences.getString("link", null) + "/utilitas/Mulai_Perjalanan/index_HistoryPenjualan?szCustomerId=" + getIntent().getStringExtra("SzId"),
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
